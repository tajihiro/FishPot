defmodule FishPotWeb.ProjectControllerTest do
  use FishPotWeb.ConnCase

  alias FishPot.Admin

  @create_attrs %{overview: "some overview", place: "some place", project_name: "some project_name"}
  ...
  def fixture(:project) do
    {:ok, project} = Admin.create_project(@create_attrs)
    project
  end
