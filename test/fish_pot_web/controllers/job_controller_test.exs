defmodule FishPotWeb.JobControllerTest do
  use FishPotWeb.ConnCase

  alias FishPot.Admin

  @create_attrs %{end_date: ~N[2010-04-17 14:00:00.000000], job_name: "some job_name", start_date: ~N[2010-04-17 14:00:00.000000]}
  ...
  def fixture(:job) do
    {:ok, job} = Admin.create_job(@create_attrs)
    job
  end
