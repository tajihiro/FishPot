defmodule FishPotWeb.UserControllerTest do
  use FishPotWeb.ConnCase

  alias FishPot.Admin

  @create_attrs %{email: "some email", first_kn_name: "some first_kn_name", first_name: "some first_name", last_kn_name: "some last_kn_name", last_name: "some last_name", passwd: "some passwd", user_id: "some user_id"}
